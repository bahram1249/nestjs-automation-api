...
@Table({ tableName: 'ECLogisticOrderGroupedDetails' })
export class ECLogisticOrderGroupedDetail extends Model {
  @Column({ type: DataType.BIGINT, primaryKey: true, autoIncrement: true })
  id: bigint;

  @Column({ type: DataType.BIGINT })
  @ForeignKey(() => ECLogisticOrderGrouped)
  groupedId: bigint;

  @BelongsTo(() => ECLogisticOrderGrouped, {
    as: 'grouped',
    foreignKey: 'groupedId',
  })
  grouped?: ECLogisticOrderGrouped;
