...
export class LogisticTotalOrderController {
  ...
  @ApiOperation({ description: 'show all total orders (logistic) - model: ECLogisticOrder' })
  @CheckPermission({ permissionSymbol: 'ecommerce.admin.totalorders.getall' })
  @Get('/')
  @ApiQuery({ name: 'filter', type: GetTotalOrderFilterDto, style: 'deepObject', explode: true })
  ...
  @ApiOperation({ description: 'show total order by id (logistic) - id is ECLogisticOrder.id' })
  ...
  @ApiOperation({ description: 'delete detail (logistic) - id is ECLogisticOrderGroupedDetail.id' })
  @CheckPermission({ permissionSymbol: 'ecommerce.admin.totalorders.removedetail' })
  ...
  @ApiOperation({ description: 'decrease detail qty (logistic) - id is ECLogisticOrderGroupedDetail.id' })
  @CheckPermission({ permissionSymbol: 'ecommerce.admin.totalorders.decreasedetail' })
  ...
  @ApiOperation({ description: 'delete order by id (logistic) - id is ECLogisticOrder.id' })
  ...
  @ApiOperation({ description: 'change shipment way (by group) (logistic) - id is ECLogisticOrderGrouped.id' })
  @CheckPermission({ permissionSymbol: 'ecommerce.admin.totalorders.changeshipmentway' })
