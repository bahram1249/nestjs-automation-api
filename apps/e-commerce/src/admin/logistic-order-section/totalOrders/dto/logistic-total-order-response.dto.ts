...
export class LogisticTotalOrderResponseDto {
...
export class LogisticOrderDeleteResponseDto {
  @ApiProperty({ example: 'ok', description: 'Result' })
  result: string;
}

export class LogisticOrderGroupedChangeResponseDto {
  @ApiProperty({ example: 1, description: 'Grouped ID' })
  id: bigint;
