...
import { ReportOrderStatusResponseDto } from '../../../dto/report-shared-response.dto';

export class BasedAdminPostResponseDto {
...
export class BasedAdminPostTotalResponseDto {
