...
import { BPMNOutboundAction, BPMNActivity, BPMNAction } from '@rahino/localdatabase/models';
...
@Module({
  imports: [SequelizeModule.forFeature([User, Permission, BPMNOutboundAction, BPMNActivity, BPMNAction])],
