...
import { BPMNOrganization, BPMNRequest, BPMNPROCESS } from '@rahino/localdatabase/models';
...
@Module({
  imports: [
    SequelizeModule.forFeature([BPMNRequest, BPMNPROCESS, BPMNOrganization, User, Permission]),
    BPMNRequestModule,
  ],
