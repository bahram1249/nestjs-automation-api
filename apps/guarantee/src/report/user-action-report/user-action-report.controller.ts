...
import { GetUserActionReportDto } from './dto';
import { GuaranteeReportUserActionListResponseDto } from './dto';
...
export class UserActionReportController {
  ...
  @ApiJsonResponse({ type: GuaranteeReportUserActionListResponseDto })
