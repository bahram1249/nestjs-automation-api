...
import { ClientReceivingDeviceSmsSenderProcessor } from './processor';
...
@Module({
  ...
  providers: [ClientReceivingDeviceSmsSenderProcessor],
})
export class ClientReceivingDeviceSmsSenderModule {}
