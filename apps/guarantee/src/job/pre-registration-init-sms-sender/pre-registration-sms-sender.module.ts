...
import { PreRegistrationInitSmsSenderProcessor } from './processor';
...
@Module({
  ...
  providers: [PreRegistrationInitSmsSenderProcessor],
})
export class PreRegistrationInitSmsSenderModule {}
