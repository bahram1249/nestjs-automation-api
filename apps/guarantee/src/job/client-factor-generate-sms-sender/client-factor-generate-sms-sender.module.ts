...
import { ClientFactorGenerateSmsSenderProcessor } from './processor';
...
@Module({
  ...
  providers: [ClientFactorGenerateSmsSenderProcessor],
})
export class ClientFactorGenerateSmsSenderModule {}
