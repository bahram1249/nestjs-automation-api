...
export class SupplierPersonService {
  ...
  async create(user: User, dto: SupplierPersonDto) {
    const organization =
      await this.organizationStuffService.getOrganizationByUserId(user.id);
  ...
  async updateById(user: User, id: number, dto: SupplierPersonDto) {
    const organization =
      await this.organizationStuffService.getOrganizationByUserId(user.id);
  ...
  private async createOrUpdateUser(
    ...
    const mappedItem = this.mapper.map(dto, SupplierPersonDto, User);
