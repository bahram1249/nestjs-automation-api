...
export class GuaranteeAdminTechnicalPersonUserResponseDto {
...
export class GuaranteeAdminTechnicalPersonResponseDto {
  ...
  @ApiProperty({
    type: () => GuaranteeAdminTechnicalPersonUserResponseDto,
    description: 'User information',
    required: false,
  })
  user?: GuaranteeAdminTechnicalPersonUserResponseDto;
