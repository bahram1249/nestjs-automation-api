...
-- gs/admin/discountCodes
IF NOT EXISTS ((SELECT 1 FROM Migrations WHERE version = 'CORE-Permissions-Data-v109'
			))
	AND EXISTS (
		SELECT 1 FROM Settings WHERE 1=1
		AND ([key] = 'SITE_NAME' AND [value] IN ('BPMN'))
...
BEGIN
	...
	DECLARE @entityName nvarchar(256) = N'DiscountCode'
	DECLARE @groupName nvarchar(256) = N'gs.admin.discountcodes'
	DECLARE @findParentMenu bit = 0;
	DECLARE @parentMenuName nvarchar(256) = N'تخفیف'
	DECLARE @menuName nvarchar(256) = N'کدهای تخفیف'
	DECLARE @menuUrl nvarchar(512) = N'/admin/gs/discountCodes'
	...
	INSERT INTO Migrations(version, createdAt, updatedAt)
	SELECT 'CORE-Permissions-Data-v109', GETDATE(), GETDATE()
END

GO

-- gs/admin/rewardRules
IF NOT EXISTS ((SELECT 1 FROM Migrations WHERE version = 'CORE-Permissions-Data-v110'
			))
	AND EXISTS (
		SELECT 1 FROM Settings WHERE 1=1
		AND ([key] = 'SITE_NAME' AND [value] IN ('BPMN'))
...
BEGIN
	...
	DECLARE @entityName nvarchar(256) = N'RewardRule'
	DECLARE @groupName nvarchar(256) = N'gs.admin.rewardrules'
	DECLARE @findParentMenu bit = 1;
	DECLARE @parentMenuName nvarchar(256) = N'تخفیف'
	DECLARE @menuName nvarchar(256) = N'قوانین پاداش'
	DECLARE @menuUrl nvarchar(512) = N'/admin/gs/rewardRules'
	...
	INSERT INTO Migrations(version, createdAt, updatedAt)
	SELECT 'CORE-Permissions-Data-v110', GETDATE(), GETDATE()
END

GO

-- gs/report/discountCodeUsages
IF NOT EXISTS ((SELECT 1 FROM Migrations WHERE version = 'CORE-Permissions-Data-v111'
			))
	AND EXISTS (
		SELECT 1 FROM Settings WHERE 1=1
		AND ([key] = 'SITE_NAME' AND [value] IN ('BPMN'))
...
BEGIN
	...
	DECLARE @entityName nvarchar(256) = N'GuaranteeDiscountCodeUsages'
	DECLARE @groupName nvarchar(256) = N'gs.report.discountcodeusages'
	DECLARE @findParentMenu bit = 1;
	DECLARE @parentMenuName nvarchar(256) = N'گزارشات'
	DECLARE @menuName nvarchar(256) = N'گزارش استفاده از کد تخفیف'
	DECLARE @menuUrl nvarchar(512) = N'/admin/gs/discountCodeUsages'
	...
	INSERT INTO Migrations(version, createdAt, updatedAt)
		SELECT 'CORE-Permissions-Data-v111', GETDATE(), GETDATE()
END

GO


-- guarantee reward history
-- reward histories
IF NOT EXISTS ( SELECT 1 FROM Migrations WHERE version = 'CORE-Permissions-Data-v112'
			)
	AND EXISTS (
		SELECT 1 FROM Settings
...
BEGIN
	...
	DECLARE @entityName nvarchar(256) = N'GuaranteeRewardHistories'
	DECLARE @groupName nvarchar(256) = N'gs.report.rewardhistories'
	...
	INSERT INTO Migrations(version, createdAt, updatedAt)
		SELECT 'CORE-Permissions-Data-v112', GETDATE(), GETDATE()
END
