        ...
        for (var row = 0, cellIndex = 0; row < 5 + 1; row++) {
          ...
          for (var col = 0; col < 7; col++, cellIndex++) {
            if (cellIndex < _start || cellIndex - _start + 1 > _end) {
              ...
              if (
                self.options.ignoreDays.indexOf(
                  self.jDateFunctions.getGDate(_dt)._toString('YYYY/0M/0D'),
                ) > -1
              ) {
                _disday = 'disday';
              }
              ...
              _cell.attr('data-jdate', _dt.toString('YYYY/0M/0D'));
              _cell.attr(
                'data-gdate',
                self.jDateFunctions.getGDate(_dt)._toString('YYYY/0M/0D'),
              );
