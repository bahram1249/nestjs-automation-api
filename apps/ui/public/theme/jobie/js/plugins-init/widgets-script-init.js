(function($) {
 ...
 var dzChartlist = function(){
	...
	var chartWidget2 = function(){
		...
		if(jQuery('#chart_widget_2').length > 0 ){
			...
			new Chart(chart_widget_2, {
				...
				data: {
					// defaultFontFamily: 'Poppins',
					labels: ["فروردین", "اردیبهشت", "خرداد", "تیر", "مرداد", "شهریور", "تیر", "مرداد", "شهریور", "مهر", "آبان", "آذر"],
					datasets: [
						{
							label: "اطلاعات اول",
	...
	var chartWidget4 = function(){
		...
		let barChartData2 = {
			// defaultFontFamily: 'Poppins',
			labels: ['یک', 'دو', 'سه', 'چهار', 'پنج', 'شش', 'هفت', 'هشت', 'نُه', 'ده', 'یازده', 'دوازده', 'سیزده', 'چهارده', 'پانزده', 'شانزده', 'هفده', 'هجده', 'نوزده', 'بیست'],
			datasets: [{
				label: 'هزینه',
	...
	var chartWidget9 = function(){
		...
		new Chart(chart_widget_9, {
			type: "line",
			data: {
				labels: ["فروردین", "اردیبهشت", "خرداد", "تیر", "مرداد", "شهریور", "مهر", "آبان", "آذر", "دی", "بهمن", "اسفند", "فرردین", "اردیبهشت", "خرداد", "تیر", "مرداد", "شهریور", "مهر", "آبان", "آذر", "دی", "بهمن", "اسفند", "فروردین", "اردیبهشت", "خرداد", "تیر", "مرداد", "شهریور", "مهر", "آبان", "آذر", "دی"],
				datasets: [{
					label: "وضعیت فروش",
